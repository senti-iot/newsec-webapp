...
import { ItemG, TextF, DSelect } from 'components/customComponents';
...
class FilterCard extends Component {
	...
	render() {
		const { title, open, handleClose, classes, anchorEl, edit, error } = this.props
...
export default withStyles(style)(FilterCard)
